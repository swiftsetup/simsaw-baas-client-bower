                    ...
                    element.bind('click', function () {
                        ...
                        var role    = 4,
                            ...
                            url     = 'https://www.facebook.com/dialog/oauth?app_id=' + appId + '&redirect_uri=' + redirectUri +
                                '&response_type=token&scope=' + fbScope,
                            fbPopUp = $window.open(
                                url,
                                'fbLogin',
                        ...
                        $window.fbOauthResponse = function (hash) {
                            ...
                            if (params.access_token) {
                                Auth.setAuthToken(params.access_token, fbScope, role, fbPopUp);
                            } else {
                                Alert.error(params.error || params.error_description || 'Unknown error');
                                fbPopUp.close();
                            }
                        };
                    });
