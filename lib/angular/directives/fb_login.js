...
define(['app', 'config'], function (app, config) {
    ...
    app.directive(
        'fbLogin',
        ['$window', 'simsaw-baas-auth-fb', 'Alert', 'simsaw/utils', function ($window, Auth, Alert, Utils) {
            ...
            return {
                restrict: 'A',
                template: '<input type="button" class="btn" value="Login with Facebook" data-ng-click="login()"/>',
                scope: {},
