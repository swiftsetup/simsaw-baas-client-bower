            ...
            return {
                ...
                link: function (scope, element, attrs) {
                    ...
                    element.bind('click', function () {
                        ...
                        var loginHint = attrs.loginHint,
                            googleScope = "email profile" + (attrs.addContactScope ?
                                    " https://www.googleapis.com/auth/contacts.readonly https://www.google.com/m8/feeds/photo" : ""),
                            role = 4,
                            w = 600,
                            h = 400,
                        ...
                        $window.googleOauthResponse = function (hash) {
                            ...
                            if (params.access_token) {
                                Auth.setAuthToken(params.access_token, googleScope, role, gPopUp);
                            } else {
                                Alert.error(params.error || params.error_description);
                                gPopUp.close();
                            }
                        };
                    });
