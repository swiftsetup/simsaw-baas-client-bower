...
define(['angular', 'simsaw/utils'], function (angular, utils) {
    ...
    var _alert,
        ...
        fileUploadTemplate = '<span class="btn btn-default fileinput-button"> ' +
            ...
            '</p>',
        simpleTemplate = '<label style="display: inline">' +
                '<div ng-transclude>' +
                    'Upload File' +
                '</div>' +
                '<div class="clearfix"></div>' +
                '<input multiple="" type="file" accept="{{accept}}" capture="camera" style="visibility:hidden"/>' +
                '<p data-ng-repeat="upload in uploads | filter: {uploading: true}">' +
    ...
    function fileUpload(scope, elem, attrs, baasRequest, Alert) {
            ...
            function ($rootScope, baasRequest, Alert) {
                ...
                return {
                    ...
                    link: function (scope, elem, attrs) {
                        fileUpload(scope, elem, attrs, baasRequest, Alert);
                    }
                };
            }
        ]
