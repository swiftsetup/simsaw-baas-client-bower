...
define(['angular'], function (angular) {
    ...
    function readFiles(scope, data, files, user) {
        ...
        for (i; i < files.length; i++) {
            var index = scope.uploads.length;
            uploadFile(scope, data, files[i], user, index);
        }
    }

    function uploadFile(scope, data, file, user, index) {
        ...
        filePath = key.replace('${filename}', file.name);
        ...
        [
            ...
            function ($rootScope, baasRequest, Alert) {
                return {
                    restrict: 'EA',
                    scope: {onComplete: '&'},
                    template: '<div class="file-upload-drop-zone"></div>' +
